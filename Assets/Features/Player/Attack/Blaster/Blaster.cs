...
{
    public sealed class Blaster : IStartable, IDisposable, ITickable
    {
        private readonly IEventPublisher<BlasterShotEvent> _blasterShotPublisher;
        // Blaster deactivates when the laser is activated
        ...
        public Blaster(
            IEventPublisher<BlasterShotEvent> blasterShotPublisher,
            IEventListener<LaserActivated> laserActivatedListener,
            IEventListener<LaserDeactivated> laserDeactivatedListener,
            StatRegistry<BlasterStats> stats,
            IFactory factory,
            IPositionProvider positionProvider)
        {
            _blasterShotPublisher = blasterShotPublisher;
        ...
        public void Tick()
        {
            ...
            if (_timer < _stats.Retrieve(BlasterStats.Interval)) return;
            Spawn();
        ...
        private void Spawn()
        {
            ...
            spawnable.SetVelocity(new Vector2(0, _stats.Retrieve(BlasterStats.ProjectileSpeed)));
        }
    }
}
