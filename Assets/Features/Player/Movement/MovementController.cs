...
namespace Features.Player.Movement
{
    public sealed class MovementController : IStartable, IDisposable, IFixedTickable
    {
        ...
        private readonly BoundsConfig _boundsConfig;
        ...
        public void FixedTick()
        {
            view.SetLinearVelocity(Mathf.Abs(_horizontalInput) < 0.01f ? 0 :
                _horizontalInput < 0 && view.XPosition > _boundsProvider.Min - _boundsConfig.Overshoot ? _horizontalInput * model.TopSpeed :
                _horizontalInput > 0 && view.XPosition < _boundsProvider.Max + _boundsConfig.Overshoot ? _horizontalInput * model.TopSpeed : 0);
        }
