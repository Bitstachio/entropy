...
{
    public sealed class BoltController : ISpawnable, IStartable, IDisposable
    {
        private readonly IBoltModel _model;
        private readonly IBoltView _view;
        private readonly ISet<string> _destroyTags;
        
        public BoltController(IBoltModel model, IBoltView view, ISet<string> destroyTags)
        {
            _model = model;
            _view = view;
