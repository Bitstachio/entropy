...
{
    public sealed class BlasterDamageDisplayController : StatDisplayController<BlasterStats>
    {
        public BlasterDamageDisplayController(
            IEventListener<StatRegistryUpdatedEvent<BlasterStats>> listener,
            IStatDisplayView view,
            StatRegistry<BlasterStats> statRegistry)
            : base(listener, view, statRegistry, BlasterStats.Damage)
        {
        }
